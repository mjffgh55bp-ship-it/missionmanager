      ...
      <div className="max-w-7xl mx-auto">
            ...
            <CardContent className="py-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="font-semibold text-gray-900 mb-1">Tips & Policy</p>
        ...
        <Dialog open={showTipsPopup} onOpenChange={setShowTipsPopup}>
          <DialogContent className="sm:max-w-lg">
            <DialogHeader><DialogTitle className="flex items-center gap-2"><Info className="w-5 h-5 text-blue-600" />Tips & Policy</DialogTitle></DialogHeader>
